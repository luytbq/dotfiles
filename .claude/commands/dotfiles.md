...
5. When asked to commit with "do not auto cherry-pick", ensure that the commit message contains exactly "[do not auto cherry-pick]" to prevent it from being cherry-picked in other branches by github actions.
