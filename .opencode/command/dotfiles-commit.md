...
5. Construct the commit message in the format: `{scope}: {description}`.
  ...
  description: should provide which functionality (prefer use keywords from the diff output if suitable, or else use the file names) was changed and how it was changed, .
